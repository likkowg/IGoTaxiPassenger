...
export class HomePage {
  ...
  constructor(public nav: NavController, public platform: Platform, public alertCtrl: AlertController,
    ...
    public tripService: TripService, public driverService: DriverService, private toastCtrl: ToastController) {
  ...
  trackDrivers() {
    ...
    this.driverTracking = setInterval(() => {
      ...
      this.geolocation.getCurrentPosition().then((resp) => {
        let locality = this.placeService.setLocalityFromGeocoder(resp);
      }, (err) => {
        console.log(err);
      });
